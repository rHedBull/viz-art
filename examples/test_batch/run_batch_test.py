#!/usr/bin/env python3
"""Quick test script for batch processing functionality.

This script demonstrates the batch processing workflow:
...
def main():
    print("=" * 60)
    print("VIZ-ART BATCH PROCESSING TEST")
    print("=" * 60)
    ...
    print("Or run: xdg-open " + str(report_path))
    print("=" * 60)
